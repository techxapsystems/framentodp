...
- [ ] Adicionar tabela de tokens de reset ao schema
- [ ] Implementar backend de recuperacao de senha
- [ ] Criar tela de "Esqueci Minha Senha"
- [ ] Criar tela de redefinicao de senha
- [ ] Integrar ao fluxo de login
- [ ] Testar fluxo completo


## Recuperacao de Senha por Email (IMPLEMENTADO)
- [x] Adicionar tabela de tokens de reset ao schema
- [x] Implementar backend de recuperação de senha (geração de token, envio de email)
- [x] Criar tela de "Esqueci Minha Senha"
- [x] Criar tela de redefinição de senha
- [x] Integrar ao fluxo de login
- [x] Testar fluxo completo
- [x] Validação de token com expiração (1 hora)
- [x] Redefinição segura de senha com hash bcrypt

...
## Módulo de Importação em Massa de Advertências (NOVO)
- [ ] Phase 1: Analisar estrutura existente de advertências
- [ ] Phase 2: Criar schema de extensão (branches, import logs, origem)
- [ ] Phase 3: Implementar parser Excel com validação e agrupamento por CPF
- [ ] Phase 4: Implementar engine de detecção de infrações e geração de texto
- [ ] Phase 5: Implementar geração de PDF para importação
- [ ] Phase 6: Criar UI de importação (upload, progresso, resultados)
- [ ] Phase 7: Integração com fluxo de baixa e download em ZIP
- [ ] Phase 8: Testes e validação completa

## Módulo de Importação em Massa de Advertências (IMPLEMENTADO)
- [x] Phase 1: Analisar estrutura existente de advertências
- [x] Phase 2: Criar schema de extensão (branches, import_batches, import_batch_details)
- [x] Phase 3: Implementar parser Excel com validação e agrupamento por CPF
- [x] Phase 4: Implementar engine de detecção de infrações e geração de texto
- [x] Phase 5: Implementar geração de PDF para importação
- [x] Phase 6: Criar UI de importação (upload, progresso, resultados)
- [x] Phase 7: Integração com fluxo de baixa e menu sidebar
- [x] Phase 8: Testes e validação
